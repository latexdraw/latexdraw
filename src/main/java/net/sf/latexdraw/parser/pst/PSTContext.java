...
public class PSTContext {
	...
	void setPspicturePoints(final net.sf.latexdraw.parser.pst.PSTParser.CoordContext coord1, final net.sf.latexdraw.parser.pst.PSTParser.CoordContext coord2) {
	...
	double valDimtoDouble(final net.sf.latexdraw.parser.pst.PSTParser.ValueDimContext valdim) {
		if(valdim == null) {
	...
	Tuple<Double, Double> valNumNumberToDoubles(final net.sf.latexdraw.parser.pst.PSTParser.ValueDimContext valdim, final TerminalNode number) {
	...
	double fromXvalDimToCoord(final net.sf.latexdraw.parser.pst.PSTParser.ValueDimContext valDim) {
		if(valDim == null) {
	...
	double fromYvalDimToCoord(final net.sf.latexdraw.parser.pst.PSTParser.ValueDimContext valDim) {
		if(valDim == null) {
			return -PSTricksConstants.DEFAULT_VALUE_MISSING_COORDINATE * ppc;
		}
