...
public class TestModifiablePointsShapeBase implements HelperTest {
	@Theory
	public void testSetRotationAngleOnly(@ModifPtShapeData final ModifiablePointsShape shape) {
	...
	@Theory
	public void testMirrorHorizontal(@ModifPtShapeData(x = {1d, 3d}, y = {1d, 1d}) final ModifiablePointsShape shape) {
	...
	@Theory
	public void testMirrorVertical(@ModifPtShapeData(x = {1d, 3d}, y = {1d, 3d}) final ModifiablePointsShape shape) {
	...
	@Theory
	public void testTranslate(@ModifPtShapeData(x = {1d, 3d}, y = {1d, 1d}) final ModifiablePointsShape shape) {
	...
	@Theory
	public void testTranslateKO(@ModifPtShapeData(x = {1d, 3d}, y = {1d, 1d}) final ModifiablePointsShape shape,
	...
	@Theory
	public void testGetGravityCentre(@ModifPtShapeData(x = {0d, 2d, 2d}, y = {0d, 0d, 2d}) final ModifiablePointsShape shape) {
		assertEquals(shape.getGravityCentre(), ShapeFactory.INST.createPoint(1, 1));
	}


	@Theory
	public void testSetPoint2(@ModifPtShapeData(x = {1d}, y = {0d}) final ModifiablePointsShape shape) {
	...
	@Theory
	public void testSetPoint2KO1(@ModifPtShapeData final ModifiablePointsShape shape,
	...
	@Theory
	public void testGetTopLeftPoint(@ModifPtShapeData(x = {0d, 2d, 2d, 0d}, y = {0d, 0d, 2d, 2d}) final ModifiablePointsShape shape) {
		assertEqualsDouble(0d, shape.getTopLeftPoint().getX());
		assertEqualsDouble(0d, shape.getTopLeftPoint().getY());
	}

	@Theory
	public void testGetTopRightPoint(@ModifPtShapeData(x = {0d, 2d, 2d, 0d}, y = {0d, 0d, 2d, 2d}) final ModifiablePointsShape shape) {
		assertEqualsDouble(2d, shape.getTopRightPoint().getX());
		assertEqualsDouble(0d, shape.getTopRightPoint().getY());
	}

	@Theory
	public void testGetBottomRightPoint(@ModifPtShapeData(x = {0d, 2d, 2d, 0d}, y = {0d, 0d, 2d, 2d}) final ModifiablePointsShape shape) {
		assertEqualsDouble(2d, shape.getBottomRightPoint().getX());
		assertEqualsDouble(2d, shape.getBottomRightPoint().getY());
	}

	@Theory
	public void testGetBottomLeftPoint(@ModifPtShapeData(x = {0d, 2d, 2d, 0d}, y = {0d, 0d, 2d, 2d}) final ModifiablePointsShape shape) {
