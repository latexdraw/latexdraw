...
public class TestTextSetter extends BaseTestCanvas {
	...
	public void testTypeTextFieldOKAddShape() {
		...
		assertTrue(canvas.getDrawing().getShapeAt(0) instanceof Text);
		final Text sh = (Text) canvas.getDrawing().getShapeAt(0);
	...
	public void testTypeEqFieldOKAddShape() {
		...
		assertEquals(1, canvas.getDrawing().size());
		assertTrue(canvas.getDrawing().getShapeAt(0) instanceof Plot);
		final Plot sh = (Plot) canvas.getDrawing().getShapeAt(0);
