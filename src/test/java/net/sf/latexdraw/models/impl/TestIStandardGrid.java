...
public class TestIStandardGrid implements HelperTest {
	@Theory
	public void testGetSetLabelsSize(@StdGridData final IStandardGrid shape, @TestedOn(ints = {0, 1, 10}) final int value) {
		shape.setLabelsSize(value);
		assertEquals(value, shape.getLabelsSize());
	}

	@Theory
	public void testGetSetLabelsSizeKO(@StdGridData final IStandardGrid shape) {
	...
	@Theory
	public void testGetSetGridEndX(@StdGridData final IStandardGrid shape, @DoubleData final double value) {
	...
	@Theory
	public void testGetSetGridEndXKO(@StdGridData final IStandardGrid shape, @DoubleData(bads = true, vals = {-20d}) final double value) {
		shape.setGridStartX(-10d);
	...
	@Theory
	public void testGetSetGridEndY(@StdGridData final IStandardGrid shape, @DoubleData final double value) {
		assumeThat(value, greaterThan(-10d));
	...
	@Theory
	public void testGetSetGridEndYKO(@StdGridData final IStandardGrid shape, @DoubleData(bads = true, vals = {-20d}) final double value) {
		shape.setGridStartY(-10d);
	...
	@Theory
	public void testGetSetGridStartY(@StdGridData final IStandardGrid shape, @DoubleData final double value) {
	...
	@Theory
	public void testGetSetGridStartYKO(@StdGridData final IStandardGrid shape, @DoubleData(bads = true, vals = {20d}) final double value) {
		shape.setGridEndY(10d);
		shape.setGridStartY(-10d);
		shape.setGridStartY(value);
	...
	@Theory
	public void testGetSetGridStartX(@StdGridData final IStandardGrid shape, @DoubleData final double value) {
		assumeThat(value, lessThan(10d));
	...
	@Theory
	public void testGetSetGridStartXKO(@StdGridData final IStandardGrid shape, @DoubleData(bads = true, vals = {20d}) final double value) {
		shape.setGridEndX(10d);
		shape.setGridStartX(-10d);
		shape.setGridStartX(value);
	...
	@Theory
	public void testSetGridStart(@StdGridData final IStandardGrid shape, @DoubleData final double x, @DoubleData final double y) {
	...
	@Theory
	public void testSetGridEnd(@StdGridData final IStandardGrid shape, @DoubleData final double x, @DoubleData final double y) {
	...
	@Theory
	public void testSetOrigin(@StdGridData final IStandardGrid shape, @DoubleData final double x, @DoubleData final double y) {
		shape.setOrigin(x, y);
	...
	@Theory
	public void testSetOriginKO(@StdGridData final IStandardGrid shape, @DoubleData(vals = {}, bads = true) final double x,
	...
	@Theory
	public void testGetSetOriginX(@StdGridData final IStandardGrid shape, @DoubleData final double value) {
		shape.setOriginX(value);
		assertEqualsDouble(value, shape.getOriginX());
	}

	@Theory
	public void testGetSetOriginXKO(@StdGridData final IStandardGrid shape, @DoubleData(bads = true, vals = {}) final double value) {
	...
	@Theory
	public void testGetSetOriginY(@StdGridData final IStandardGrid shape, @DoubleData final double value) {
		shape.setOriginY(value);
		assertEqualsDouble(value, shape.getOriginY());
	}

	@Theory
	public void testGetSetOriginYKO(@StdGridData final IStandardGrid shape, @DoubleData(bads = true, vals = {}) final double value) {
	...
	@Theory
	public void testDuplicate(@StdGridData final IStandardGrid shape) {
	...
	@Theory
	public void testCopy(@StdGridData final IStandardGrid shape, @StdGridData final IStandardGrid shape2) {
