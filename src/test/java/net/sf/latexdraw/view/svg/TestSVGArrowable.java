...
public class TestSVGArrowable extends TestSVGBase<ArrowableSingleShape> {
	...
	void testArrowArrow1(final ArrowableSingleShape sh, final ArrowStyle arr) {
	...
	@ParameterizedTest
	@MethodSource("arrowsParamsDiv")
	void testArrowArrow2(final ArrowableSingleShape sh, final ArrowStyle arr) {
	...
	@ParameterizedTest
	@MethodSource("arrowsParamsDiv")
	void testArrowBarParamsArr2(final ArrowableSingleShape sh, final ArrowStyle arr) {
	...
	@ParameterizedTest
	@MethodSource("arrowsParamsDiv")
	void testArrowBracketParamsArr1(final ArrowableSingleShape sh, final ArrowStyle arr) {
	...
	@ParameterizedTest
	@MethodSource("arrowsParamsDiv")
	void testArrowBracketParamsArr2(final ArrowableSingleShape sh, final ArrowStyle arr) {
		assumeTrue(arr.isSquareBracket());
		assumeFalse(sh instanceof Axes);
		sh.setArrowStyle(arr, -1);
		final ArrowableSingleShape s2 = produceOutputShapeFrom(sh);
	...
	@ParameterizedTest
	@MethodSource("arrowsParamsDiv")
	void testArrowRBracketParamsArr1(final ArrowableSingleShape sh, final ArrowStyle arr) {
	...
	@ParameterizedTest
	@MethodSource("arrowsParamsDiv")
	void testArrowRBracketParamsArr2(final ArrowableSingleShape sh, final ArrowStyle arr) {
		assumeTrue(arr.isRoundBracket());
		assumeFalse(sh instanceof Axes);
		sh.setArrowStyle(arr, 0);
		final ArrowableSingleShape s2 = produceOutputShapeFrom(sh);
	...
	@ParameterizedTest
	@MethodSource("arrowsParamsDiv")
	void testArrowCircleDiskParamsArr1(final ArrowableSingleShape sh, final ArrowStyle arr) {
	...
	@ParameterizedTest
	@MethodSource("arrowsParamsDiv")
	void testArrowCircleDiskParamsArr2(final ArrowableSingleShape sh, final ArrowStyle arr) {
		assumeTrue(arr.isCircleDisk());
		assumeFalse(sh instanceof Axes);
		sh.setArrowStyle(arr, 0);
		final ArrowableSingleShape s2 = produceOutputShapeFrom(sh);
