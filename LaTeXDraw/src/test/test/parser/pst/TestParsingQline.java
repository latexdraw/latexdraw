...
public class TestParsingQline extends TestPSTParser {
	...
	public void testCoordinatesCm() throws ParseException {
		...
		assertEquals(35.*IShape.PPC, line.getPtAt(0).getX());
		assertEquals(20.*IShape.PPC*-1., line.getPtAt(0).getY());
		assertEquals(11.12*IShape.PPC, line.getPtAt(1).getX());
		assertEquals(-2.*IShape.PPC*-1., line.getPtAt(1).getY());
