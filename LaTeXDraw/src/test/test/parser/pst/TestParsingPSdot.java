...
public class TestParsingPSdot extends TestParsingShape {
	...
	public void testDotsizeNoUnit() throws ParseException {
		...
		assertEquals((1.5*IShape.PPC+2.*PSTricksConstants.DEFAULT_LINE_WIDTH*IShape.PPC)/2., dot.getRadius());
		assertTrue(PSTParser.errorLogs().isEmpty());
	}
	...
	public void testDotsizeNoNum() throws ParseException {
		...
		assertEquals(1.5*IShape.PPC/2., dot.getRadius());
		assertTrue(PSTParser.errorLogs().isEmpty());
	}
	...
	public void testDotsize() throws ParseException {
		...
		assertEquals((1.5*IShape.PPC+4.*PSTricksConstants.DEFAULT_LINE_WIDTH*IShape.PPC)/2., dot.getRadius());
		assertTrue(PSTParser.errorLogs().isEmpty());
	}
