...
public class Zoomer extends Instrument {
	...
	public Zoomer(final Zoomable zoomable) {
		...
		zoomSpinner					= new MSpinner(new SpinnerNumberModel(100, Zoomable.MIN_ZOOM*100, Zoomable.MAX_ZOOM*100, Zoomable.ZOOM_INCREMENT*100), null);
...
class Scroll2Zoom extends Link<Zoom, KeysScrolling, Zoomer> {
	...
	public void updateAction() {
		action.setZoomLevel(instrument.zoomable.getZoom() + interaction.getNumberUp()*Zoomable.ZOOM_INCREMENT);
	}
