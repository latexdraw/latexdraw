...
class LGroup extends LShape implements IGroup {
	...
	public void setGridWidthList(final List<Double> values) {
		if(values!=null && values.size()==shapes.size())
			for(int i=0, size=shapes.size(); i<size; i++)
				if(values.get(i)!=null && shapes.get(i) instanceof IGrid)
					((IGrid)shapes.get(i)).setGridWidth(values.get(i));
	}


	@Override
	public List<Double> getGridWidthList() {
		final List<Double> list = new ArrayList<Double>();

		for(final IShape sh : shapes)
			list.add(sh instanceof IGrid ? ((IGrid)sh).getGridWidth() : null);
	...
	public void setGridDotsList(final List<Integer> values) {
		if(values!=null && values.size()==shapes.size())
			for(int i=0, size=shapes.size(); i<size; i++)
				if(values.get(i)!=null && shapes.get(i) instanceof IGrid)
					((IGrid)shapes.get(i)).setGridDots(values.get(i));
	}
	...
	public List<Integer> getGridDotsList() {
		...
		for(final IShape sh : shapes)
			list.add(sh instanceof IGrid ? ((IGrid)sh).getGridDots() : null);
	...
	public void setSubGridDotsList(final List<Integer> values) {
		if(values!=null && values.size()==shapes.size())
			for(int i=0, size=shapes.size(); i<size; i++)
				if(values.get(i)!=null && shapes.get(i) instanceof IGrid)
					((IGrid)shapes.get(i)).setSubGridDots(values.get(i));
	}
	...
	public List<Integer> getSubGridDotsList() {
		...
		for(final IShape sh : shapes)
			list.add(sh instanceof IGrid ? ((IGrid)sh).getSubGridDots() : null);
	...
	public void setSubGridDivList(final List<Integer> values) {
		if(values!=null && values.size()==shapes.size())
			for(int i=0, size=shapes.size(); i<size; i++)
				if(values.get(i)!=null && shapes.get(i) instanceof IGrid)
					((IGrid)shapes.get(i)).setSubGridDiv(values.get(i));
	}
	...
	public void setFreeHandIntervalList(final List<Integer> values) {
		if(values!=null && values.size()==shapes.size())
			for(int i=0, size=shapes.size(); i<size; i++)
				if(values.get(i)!=null && shapes.get(i) instanceof IFreehand)
					((IFreehand)shapes.get(i)).setInterval(values.get(i));
	}
	...
	public List<Integer> getFreeHandIntervalList() {
		...
		for(final IShape sh : shapes)
			list.add(sh instanceof IFreehand ? ((IFreehand)sh).getInterval() : null);
