 ...
 * @version 3.0
 */
public class Package2TextViewMapping extends Object2ObjectMapping<ISingleton<String>, LTextView> {
	/**
	 * Creates the mapping.
	 ...
	 * @since 3.0
	 */
	public Package2TextViewMapping(final ISingleton<String> packages, final LTextView textView) {
