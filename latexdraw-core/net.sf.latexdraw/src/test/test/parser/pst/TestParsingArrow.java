...
public class TestParsingArrow extends TestPSTParser {
	...
	public void testParamArrowScaleDimDim() throws ParseException {
		parser.parsePSTCode("\\psline[arrows=<->, arrowscale=0.1 cm 3](1,1)"); //$NON-NLS-1$
		assertTrue(PSTParser.errorLogs().isEmpty());
	}

	@Test
	public void testParamArrowScaleDim() throws ParseException {
		parser.parsePSTCode("\\psline[arrows=<->, arrowscale=2.55](1,1)"); //$NON-NLS-1$
		assertTrue(PSTParser.errorLogs().isEmpty());
	}
	...
	public void testNonecc() throws ParseException {
		IPolyline line = (IPolyline)parser.parsePSTCode("\\psline{-cc}(1,1)").get().getShapeAt(0); //$NON-NLS-1$
		assertEquals(ArrowStyle.NONE, line.getArrowStyle(0));
	...
	public void testNoneCircleIn() throws ParseException {
		IPolyline line = (IPolyline)parser.parsePSTCode("\\psline{-oo}(1,1)").get().getShapeAt(0); //$NON-NLS-1$
		assertEquals(ArrowStyle.NONE, line.getArrowStyle(0));
	...
	public void testNoneCircleEnd() throws ParseException {
		IPolyline line = (IPolyline)parser.parsePSTCode("\\psline{-o}(1,1)").get().getShapeAt(0); //$NON-NLS-1$
		assertEquals(ArrowStyle.NONE, line.getArrowStyle(0));
