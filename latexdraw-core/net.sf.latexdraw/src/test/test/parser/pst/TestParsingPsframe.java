...
public class TestParsingPsframe extends TestParsingShape {
	...
	public void testCoordinatesPt() throws ParseException {
		...
		assertEquals(0., rec.getPosition().getX());
		assertEquals(0., rec.getPosition().getY());
		assertEquals(35.*IShape.PPC/PSTricksConstants.CM_VAL_PT, rec.getWidth());
		assertEquals(20.*IShape.PPC/PSTricksConstants.CM_VAL_PT, rec.getHeight());
		assertTrue(PSTParser.errorLogs().isEmpty());
	}
	...
	public void testCoordinatesMm() throws ParseException {
		...
		assertEquals(0., rec.getPosition().getX());
		assertEquals(0., rec.getPosition().getY());
		assertEquals(35.*IShape.PPC, rec.getWidth());
		assertEquals(20.*IShape.PPC, rec.getHeight());
		assertTrue(PSTParser.errorLogs().isEmpty());
	}
	...
	public void testCoordinatesInch() throws ParseException {
		...
		assertEquals(0., rec.getPosition().getX());
		assertEquals(0., rec.getPosition().getY());
		assertEquals(35.*IShape.PPC/2.54, rec.getWidth());
		assertEquals(20.*IShape.PPC/2.54, rec.getHeight());
		assertTrue(PSTParser.errorLogs().isEmpty());
	}
	...
	public void test2CoordinatesIntOppositeAll() throws ParseException {
		...
		assertEquals(10.*IShape.PPC, rec.getPosition().getX());
		assertEquals(20.*-IShape.PPC, rec.getPosition().getY());
		assertEquals(25.*IShape.PPC, rec.getWidth());
		assertEquals(30.*IShape.PPC, rec.getHeight());
		assertTrue(PSTParser.errorLogs().isEmpty());
	}
	...
	public void test2CoordinatesFloatSigns2() throws ParseException {
		...
		assertEquals(-.5*IShape.PPC, rec.getPosition().getX());
		assertEquals(-5.*-IShape.PPC, rec.getPosition().getY());
		assertEquals(36.*IShape.PPC, rec.getWidth());
		assertEquals(55.5*IShape.PPC, rec.getHeight());
		assertTrue(PSTParser.errorLogs().isEmpty());
	}
	...
	public void test2CoordinatesFloatSigns() throws ParseException {
		...
		assertEquals(.5*-IShape.PPC, rec.getPosition().getY());
		assertEquals(35.*IShape.PPC, rec.getWidth());
		assertEquals(50.*IShape.PPC, rec.getHeight());
		assertTrue(PSTParser.errorLogs().isEmpty());
	}
	...
	public void test2CoordinatesFloat() throws ParseException {
		...
		assertEquals(10.5*IShape.PPC, rec.getPosition().getX());
		assertEquals(20.5*-IShape.PPC, rec.getPosition().getY());
		assertEquals(25.*IShape.PPC, rec.getWidth());
		assertEquals(30.*IShape.PPC, rec.getHeight());
		assertTrue(PSTParser.errorLogs().isEmpty());
	}
	...
	public void test2CoordinatesTwoFirstMissing() throws ParseException {
		...
		assertEquals(PSTricksConstants.DEFAULT_VALUE_MISSING_COORDINATE*IShape.PPC, rec.getPosition().getX());
		assertEquals(PSTricksConstants.DEFAULT_VALUE_MISSING_COORDINATE*-IShape.PPC, rec.getPosition().getY());
		assertEquals(34.*IShape.PPC, rec.getWidth());
		assertEquals(49.*IShape.PPC, rec.getHeight());
		assertTrue(PSTParser.errorLogs().isEmpty());
	}
	...
	public void test2CoordinatesTwoLastMissing() throws ParseException {
		...
		assertEquals(0., rec.getPosition().getX());
		assertEquals(0., rec.getPosition().getY());
		assertEquals((double)IShape.PPC, rec.getWidth());
		assertEquals((double)IShape.PPC, rec.getHeight());
		assertTrue(PSTParser.errorLogs().isEmpty());
	}
}
