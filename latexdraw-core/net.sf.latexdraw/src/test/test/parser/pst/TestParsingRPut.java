...
public class TestParsingRPut extends TestPSTParser {
	...
	public void testRefPoint_None() throws ParseException {
		...
		assertEquals(10.*IShape.PPC, txt.getPosition().getX());
		assertEquals(-20.*IShape.PPC, txt.getPosition().getY());
	}
	...
	public void testDoubleRputRotationMustNotRotateOtherShapes() throws ParseException {
		...
		assertTrue(PSTParser.errorLogs().isEmpty());
		assertEquals(Math.toRadians(-90), txt.getRotationAngle());
	...
	public void testTripleRputRotationWithStar() throws ParseException {
		...
		assertTrue(PSTParser.errorLogs().isEmpty());
		assertEquals(-80., Math.toDegrees(txt.getRotationAngle()));
	}
	...
	public void testDoubleRputPosition() throws ParseException {
		...
		assertEquals(3.*IShape.PPC, txt.getPosition().getX());
		assertEquals(-5.*IShape.PPC, txt.getPosition().getY());
	}
	...
	public void testRPutCoordStarFloatText() throws ParseException {
		...
		assertTrue(PSTParser.errorLogs().isEmpty());
		assertEquals("coucou", txt.getText());
		assertEquals((double)IShape.PPC, txt.getPosition().getX());
		assertEquals(-2.*IShape.PPC, txt.getPosition().getY());
		assertEquals(Math.toRadians(90.8929), txt.getRotationAngle());
	}
	...
	public void testRPutCoordRotationRText() throws ParseException {
		...
		assertEquals((double)IShape.PPC, txt.getPosition().getX());
		assertEquals(-2.*IShape.PPC, txt.getPosition().getY());
		assertEquals(Math.toRadians(-270.), txt.getRotationAngle());
	}
	...
	public void testRPutCoordRotationDText() throws ParseException {
		...
		assertEquals((double)IShape.PPC, txt.getPosition().getX());
		assertEquals(-2.*IShape.PPC, txt.getPosition().getY());
		assertEquals(Math.toRadians(-180.), txt.getRotationAngle());
	}
	...
	public void testRPutCoordRotationDoubleText() throws ParseException {
		...
		assertEquals((double)IShape.PPC, txt.getPosition().getX());
		assertEquals(-2.*IShape.PPC, txt.getPosition().getY());
		assertEquals(Math.toRadians(10.), txt.getRotationAngle());
	}
