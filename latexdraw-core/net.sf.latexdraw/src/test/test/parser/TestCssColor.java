...
public class TestCssColor extends TestCase {
	...
	public void testGetColour() {
		...
		assertEquals(CSSColors.INSTANCE.getColor(CSSColors.CSS_DARKGREY_NAME), CSSColors.CSS_DARKGREY_RGB_VALUE);
		...
		assertEquals(CSSColors.INSTANCE.getColor(CSSColors.CSS_DARKSLATEGREY_NAME), CSSColors.CSS_DARKSLATEGREY_RGB_VALUE);
		...
		assertEquals(CSSColors.INSTANCE.getColor(CSSColors.CSS_DIMGREY_NAME), CSSColors.CSS_DIMGREY_RGB_VALUE);
		...
		assertEquals(CSSColors.INSTANCE.getColor(CSSColors.CSS_GREY_NAME), CSSColors.CSS_GREY_RGB_VALUE);
		...
		assertEquals(CSSColors.INSTANCE.getColor(CSSColors.CSS_LIGHTGREY_NAME), CSSColors.CSS_LIGHTGREY_RGB_VALUE);
		...
		assertEquals(CSSColors.INSTANCE.getColor(CSSColors.CSS_LIGHTSLATEGREY_NAME), CSSColors.CSS_LIGHTSLATEGREY_RGB_VALUE);
		...
		assertEquals(CSSColors.INSTANCE.getColor(CSSColors.CSS_SLATEGREY_NAME), CSSColors.CSS_SLATEGREY_RGB_VALUE);
		...
		assertNull(CSSColors.INSTANCE.getColor("fjdsfijsdofijdsofijertngf"));
	}
	...
	public void testGetColorName() {
		...
		assertNull(CSSColors.INSTANCE.getColorName(new Color(3, 2, 1), false));
		assertNotNull(CSSColors.INSTANCE.getColorName(new Color(4, 2, 1), true));
		...
		assertEquals(CSSColors.INSTANCE.getColorName(new Color(255,255,255), false), CSSColors.CSS_WHITE_NAME);
	...
	public void testGetRGBColour() {
		...
		assertNull(CSSColors.INSTANCE.getRGBColour("dsqdqsdgfhfdsfs"));
		assertNull(CSSColors.INSTANCE.getRGBColour("#12"));
		assertNull(CSSColors.INSTANCE.getRGBColour("#DHS78EZ7DS"));
		assertEquals(CSSColors.INSTANCE.getRGBColour("#580"), new Color(85, 136, 0));
	...
	public void testSVGRGBtoRGB() {
		...
		assertNull(CSSColors.INSTANCE.svgRgbtoRgb(""));
		assertNull(CSSColors.INSTANCE.svgRgbtoRgb("dsfdgdui"));
		assertNull(CSSColors.INSTANCE.svgRgbtoRgb("rgbdf"));
		assertNull(CSSColors.INSTANCE.svgRgbtoRgb("rgb()"));
		assertNull(CSSColors.INSTANCE.svgRgbtoRgb("rgb("));
		assertNull(CSSColors.INSTANCE.svgRgbtoRgb("rgb(a, b, c)"));
		assertNull(CSSColors.INSTANCE.svgRgbtoRgb("rgb(12, 76, )"));
		assertNull(CSSColors.INSTANCE.svgRgbtoRgb("rgb(12, )"));
		assertNull(CSSColors.INSTANCE.svgRgbtoRgb("rgb(,,)"));
		assertNull(CSSColors.INSTANCE.svgRgbtoRgb("rgb(123,12,98,98)"));
		assertNull(CSSColors.INSTANCE.svgRgbtoRgb("rgb(98721,-12,0987)"));
		assertNull(CSSColors.INSTANCE.svgRgbtoRgb("rgb(0%,0,0%)"));
