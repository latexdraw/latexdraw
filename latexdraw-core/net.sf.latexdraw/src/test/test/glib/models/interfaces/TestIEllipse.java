...
//		ILine line = ShapeFactory.createLine(ShapeFactory.createPoint(-10,0), ShapeFactory.createPoint(10,0));
...
//		ILine line = ShapeFactory.createLine(ShapeFactory.createPoint(-10,1), ShapeFactory.createPoint(10,1));
//		shape.setPosition(-1,1);
//		shape.setWidth(2);
//		shape.setHeight(2);
//		IPoint[] pts = shape.getIntersection(line);
...
//		ILine line = ShapeFactory.createLine(ShapeFactory.createPoint(0,10), ShapeFactory.createPoint(0,-10));
//		shape.setPosition(-1,1);
//		shape.setWidth(2);
//		shape.setHeight(2);
//		IPoint[] pts = shape.getIntersection(line);
...
//		ILine line = ShapeFactory.createLine(ShapeFactory.createPoint(1,-10), ShapeFactory.createPoint(1,10));
//		shape.setPosition(-1,1);
//		shape.setWidth(2);
//		shape.setHeight(2);
//		IPoint[] pts = shape.getIntersection(line);
