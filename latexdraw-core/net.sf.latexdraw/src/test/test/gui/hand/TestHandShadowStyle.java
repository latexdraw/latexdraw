...
public class TestHandShadowStyle extends TestShadowStyleGUI {
	...
	public void testSelectShadowCBHand() {
		...
		checkShadow.execute();
		assertEquals(shadowCB.isSelected(), hand.getCanvas().getDrawing().getSelection().getShapeAt(1).hasShadow());
		assertEquals(shadowCB.isSelected(), hand.getCanvas().getDrawing().getSelection().getShapeAt(2).hasShadow());
	...
	public void testPickShadowColourHand() {
		...
		pickShadCol.execute();
		assertEquals(shadowColB.getValue(), hand.getCanvas().getDrawing().getSelection().getShapeAt(1).getShadowCol().toJFX());
		assertEquals(shadowColB.getValue(), hand.getCanvas().getDrawing().getSelection().getShapeAt(2).getShadowCol().toJFX());
	...
	public void testIncrementShadowSizeHand() {
		...
		assertEquals(shadowSizeField.getValue(), hand.getCanvas().getDrawing().getSelection().getShapeAt(1).getShadowSize(), 0.0001);
		assertEquals(shadowSizeField.getValue(), hand.getCanvas().getDrawing().getSelection().getShapeAt(2).getShadowSize(), 0.0001);
	...
	public void testIncrementShadowAngleHand() {
		...
		assertEquals(Math.toRadians(shadowAngleField.getValue()), hand.getCanvas().getDrawing().getSelection().getShapeAt(1).getShadowAngle(), 0.0001);
		assertEquals(Math.toRadians(shadowAngleField.getValue()), hand.getCanvas().getDrawing().getSelection().getShapeAt(2).getShadowAngle(), 0.0001);
