 ...
 * This trait defines routines for executing DnDs on a GUI.
 */
public interface FxRobotDnD extends FxRobotInterface {
	/**
	 * Executes a DnD from the given position <code>src</code> to the given position <code>tgt</code> using the given button <code>button</code>.
