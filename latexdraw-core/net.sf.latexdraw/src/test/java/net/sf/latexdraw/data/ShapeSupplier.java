...
public class ShapeSupplier extends ParameterSupplier {
	...
	public List<PotentialAssignment> getValueSources(final ParameterSignature sig) {
		return Stream.of(
			...
			ShapeFactory.INST.createCircleArc(ShapeFactory.INST.createPoint(51d, 73d), 23d),
			ShapeFactory.INST.createGrid(ShapeFactory.INST.createPoint(13d, 84d)),
			...
			ShapeFactory.INST.createDot(ShapeFactory.INST.createPoint(12, 43)),
			...
			ShapeFactory.INST.createPolygon(Arrays.asList(ShapeFactory.INST.createPoint(51d, 73d), ShapeFactory.INST.createPoint(151d, 173d),
				ShapeFactory.INST.createPoint(251d, 33d))),
			ShapeFactory.INST.createAxes(ShapeFactory.INST.createPoint(33, 46)),
