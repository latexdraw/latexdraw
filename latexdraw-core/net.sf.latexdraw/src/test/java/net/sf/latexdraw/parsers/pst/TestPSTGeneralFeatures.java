...
public class TestPSTGeneralFeatures extends TestPSTParser {
	@Test
	public void testBug756733() throws ParseException {
	...
	@Test
	public void test_bug_psset_setOfShapes() throws ParseException {
	...
	@Test
	public void test_psset_linewidth() throws ParseException {
	...
	public void test_BeginCenter_fail_no_begin() throws ParseException {
		parser.parsePSTCode("\\psline(1,1)(1,0)\\end{center}"); //$NON-NLS-1$
	}

	@Test(expected = ParseException.class)
	public void test_BeginCenter_fail_no_end() throws ParseException {
		parser.parsePSTCode("\\begin{center}\\psline(1,1)(1,0)"); //$NON-NLS-1$
	}

	@Test(expected = ParseException.class)
	public void test_BeginCenter_failWithBeginPsPictureInterlacing() throws ParseException {
		parser.parsePSTCode("\\begin{center}\\begin{pspicture}(1,1)\\psline(1,1)(1,0)\\end{center}\\end{pspicture}"); //$NON-NLS-1$
	}

	@Test
	public void test_BeginCenter_okWithBeginPsPicture() throws ParseException {
	...
	@Test
	public void test_BeginCenter_ok() throws ParseException {
	...
	@Test
	public void test_psscalebox() throws ParseException {
	...
	@Test
	public void test_scalebox() throws ParseException {
	...
	@Test
	public void testTwoShapesDoNotShareTheirParameters() throws ParseException {
	...
	@Test
	public void testDefineColor_hsb() throws ParseException {
		parser.parsePSTCode("\\definecolor{color0b}{hsb}{1,0, 0.5}"); //$NON-NLS-1$
		assertTrue(PSTParser.errorLogs().isEmpty());
	}

	@Test
	public void testDefineColor_HTML() throws ParseException {
		parser.parsePSTCode("\\definecolor{color0b}{HTML}{#001eff}"); //$NON-NLS-1$
		assertTrue(PSTParser.errorLogs().isEmpty());
	}

	@Test
	public void testDefineColor_gray() throws ParseException {
		parser.parsePSTCode("\\definecolor{color0b}{gray}{0.4}"); //$NON-NLS-1$
		assertTrue(PSTParser.errorLogs().isEmpty());
	}

	@Test
	public void testDefineColor_cmyk() throws ParseException {
		parser.parsePSTCode("\\definecolor{color0b}{cmyk}{0.2,0.6,0.5,0.3}"); //$NON-NLS-1$
		assertTrue(PSTParser.errorLogs().isEmpty());
	}

	@Test
	public void testDefineColor_cmy() throws ParseException {
		parser.parsePSTCode("\\definecolor{color0b}{cmy}{0.2,0.6,0.5}"); //$NON-NLS-1$
		assertTrue(PSTParser.errorLogs().isEmpty());
	}

	@Test
	public void testDefineColor_RGB() throws ParseException {
	...
	@Test
	public void testrgbColorUsedInShape() throws ParseException {
	...
	@Test
	public void testHTMLColorUsedInShape() throws ParseException {
	...
	@Test
	public void testgrayColorUsedInShape() throws ParseException {
	...
	@Test
	public void testcmyColorUsedInShape() throws ParseException {
	...
	@Test
	public void testcmykColorUsedInShape() throws ParseException {
	...
	@Test
	public void testhsbColorUsedInShape() throws ParseException {
	...
	@Test(expected = ParseException.class)
	public void testBackSlackNotSeparatedFromCommand() throws ParseException {
		parser.parsePSTCode("\\ specialCoors"); //$NON-NLS-1$
	}

	@Test(expected = ParseException.class)
	public void testErrorOnNotClosedParamsBlock() throws ParseException {
		parser.parsePSTCode("\\psframe[linewidth=0.04, dimen=o"); //$NON-NLS-1$
	}

	@Test(expected = ParseException.class)
	public void testNotCloseBracketShouldNotParse() throws ParseException {
		parser.parsePSTCode("{ "); //$NON-NLS-1$
	}

	@Test
	public void testParseOrigin() {// throws ParseException {
		// TODO
	...
	@Test
	public void testParseSwapaxes() throws ParseException {
	...
	@Test
	public void testClosedBracketsMustParse() throws ParseException {
	...
	@Test
	public void testBackSlashBracketShouldBeIgnored() throws ParseException {
		assertTrue(parser.parsePSTCode("{ \\{ }").isDefined()); //$NON-NLS-1$
		assertTrue(parser.parsePSTCode("{ \\} }").isDefined()); //$NON-NLS-1$
	}
