...
public class TestIArc implements HelperTest {
	...
	@Theory
	public void testNotNullStartAngleProp(@ArcData final ICircleArc shape) {
		assertNotNull(shape.angleStartProperty());
	}

	@Theory
	public void testNotNullEndAngleProp(@ArcData final ICircleArc shape) {
		assertNotNull(shape.angleEndProperty());
	}

	@Theory
	public void testNotNullArcStyleProp(@ArcData final ICircleArc shape) {
