...
public class TestIArrow {
	...
	private void assertArrowEquals(final IArrow arrow2) {
	...
	public void testConstructor2NULLArrow() {
		new LArrow(null, arrowable);
	}

	@Test(expected = NullPointerException.class)
	public void testConstructor2NULLArrowable() {
		new LArrow(new LArrow(arrowable), null);
	}

	@Test
	public void testConstructor2CopyOK() {
		setArrowParams();
		assertArrowEquals(new LArrow(arrow, arrowable));
	}
	...
	public void testGetArrowLine() {
		final ILine line = ShapeFactory.INST.createLine(1d, 2d, 3d, 4d);
