...
// extends InteractorImpl[InsertPSTCode, ButtonPressed, CodeInserter](ins,
// false, classOf[InsertPSTCode], classOf[ButtonPressed]){
...
// interaction.getButton==instrument.insertCodeDialog.getOkButton
// }
//
//
// /**
...
// extends InteractorImpl[InactivateInstrument, ButtonPressed,
// CodeInserter](ins, false, classOf[InactivateInstrument],
// classOf[ButtonPressed]){
// override def initAction() {
...
// extends InteractorImpl[InactivateInstrument, WindowClosed, CodeInserter](ins,
// false, classOf[InactivateInstrument], classOf[WindowClosed]){
// override def initAction() {
// action.setInstrument(getInstrument)
// }
//
