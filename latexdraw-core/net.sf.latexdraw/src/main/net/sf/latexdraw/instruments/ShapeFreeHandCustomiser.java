...
public class ShapeFreeHandCustomiser extends ShapePropertyCustomiser implements Initializable, JFXWidgetCreator {
	...
	// private abstract static class CheckboxForShapeFreeHandCust<A extends
	// ShapePropertyAction> extends CheckBoxForCustomiser<A,
	// ShapeFreeHandCustomiser> {
	// protected CheckboxForShapeFreeHandCust(final ShapeFreeHandCustomiser
	...
	// private static class Checkbox2PencilFreeHand extends
	// CheckboxForShapeFreeHandCust<ModifyPencilParameter> {
	// protected Checkbox2PencilFreeHand(final ShapeFreeHandCustomiser
	...
	// private static class Checkbox2SelectionFreeHand extends
	// CheckboxForShapeFreeHandCust<ModifyShapeProperty> {
	// protected Checkbox2SelectionFreeHand(final ShapeFreeHandCustomiser
	// instrument) throws InstantiationException, IllegalAccessException {
	...
	// private abstract static class SpinnerForShapeFreeHandCust<A extends
	// ShapePropertyAction> extends SpinnerForCustomiser<A,
	// ShapeFreeHandCustomiser> {
	// protected SpinnerForShapeFreeHandCust(final ShapeFreeHandCustomiser
	// instrument, final Class<A> clazzAction) throws InstantiationException,
	// IllegalAccessException {
	// super(instrument, clazzAction);
	// }
	...
	// private static class Spinner2PencilFreeHand extends
	// SpinnerForShapeFreeHandCust<ModifyPencilParameter> {
	// protected Spinner2PencilFreeHand(final ShapeFreeHandCustomiser
	// instrument) throws InstantiationException, IllegalAccessException {
	// super(instrument, ModifyPencilParameter.class);
	// }
	//
	...
	// * This link maps a colour button to the selected shapes.
	// */
	// private static class Spinner2SelectionFreeHand extends
	// SpinnerForShapeFreeHandCust<ModifyShapeProperty> {
	// protected Spinner2SelectionFreeHand(final ShapeFreeHandCustomiser
	// instrument) throws InstantiationException, IllegalAccessException {
	// super(instrument, ModifyShapeProperty.class);
	// }
	//
	...
	// private abstract static class Combobox2CustomFH<A extends
	// ShapePropertyAction> extends ListForCustomiser<A,
	// ShapeFreeHandCustomiser> {
	// protected Combobox2CustomFH(final ShapeFreeHandCustomiser ins, final
	...
	//
	//
	// /** Maps a combobox to an action that modifies freehand's parameters of
	// the pencil. */
	// private static class Combobox2CustomPencilFH extends
	// Combobox2CustomFH<ModifyPencilParameter> {
	// protected Combobox2CustomPencilFH(final ShapeFreeHandCustomiser ins)
	...
	//
	//
	// /** Maps a combobox to an action that modifies the freehand's parameters
	// of the selection. */
	// private static class Combobox2CustomSelectedFH extends
	// Combobox2CustomFH<ModifyShapeProperty> {
	// protected Combobox2CustomSelectedFH(final ShapeFreeHandCustomiser ins)
	// throws InstantiationException, IllegalAccessException {
