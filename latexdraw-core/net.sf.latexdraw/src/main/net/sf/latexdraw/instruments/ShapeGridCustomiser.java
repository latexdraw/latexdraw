...
public class ShapeGridCustomiser extends ShapePropertyCustomiser {
	...
	// private abstract static class CheckBox4ShapeGridCust<A extends
	// ShapePropertyAction> extends ButtonPressedForCustomiser<A,
	// ShapeGridCustomiser> {
	// protected CheckBox4ShapeGridCust(final ShapeGridCustomiser ins, final
	// Class<A> actClazz) throws InstantiationException, IllegalAccessException
	// {
	// super(ins, actClazz);
	// }
	//
	...
	// return interaction.getButton()==instrument.labelsYInvertedCB ||
	// interaction.getButton()==instrument.labelsXInvertedCB;
	// }
	//
	// @Override
	...
	//
	//
	// /** The link that maps a checkbox to an action that modifies the
	// selection. */
	// private static class CheckBox2ModifySelectionGrid extends
	// CheckBox4ShapeGridCust<ModifyShapeProperty> {
	// protected CheckBox2ModifySelectionGrid(final ShapeGridCustomiser ins)
	...
	// */
	// private static class CheckBox2ModifyPencilGrid extends
	// CheckBox4ShapeGridCust<ModifyPencilParameter> {
	// protected CheckBox2ModifyPencilGrid(final ShapeGridCustomiser ins) throws
	...
	//
	//
	// private abstract static class SpinnerForShapeGridCust<A extends
	// ShapePropertyAction> extends SpinnerForCustomiser<A, ShapeGridCustomiser>
	// {
	// protected SpinnerForShapeGridCust(final ShapeGridCustomiser instrument,
	...
	// public boolean isConditionRespected() {
	// final Object spinner = interaction.getSpinner();
	// return spinner==instrument.gridWidth || spinner==instrument.subGridWidth
	// || spinner==instrument.gridDots ||
	...
	// interaction.getSpinner()==instrument.subGridDots ||
	...
	//
	//
	// private static class Spinner2PencilGrid extends
	// SpinnerForShapeGridCust<ModifyPencilParameter> {
	// /**
	// * Creates the link.
	// * @param instrument The instrument that contains the link.
	// * @throws InstantiationException If an error of instantiation
	// (interaction, action) occurs.
	// * @throws IllegalAccessException If no free-parameter constructor are
	// provided.
	// */
	// protected Spinner2PencilGrid(final ShapeGridCustomiser instrument) throws
	// InstantiationException, IllegalAccessException {
	...
	// */
	// private static class Spinner2SelectionGrid extends
	// SpinnerForShapeGridCust<ModifyShapeProperty> {
	// /**
	// * Creates the link.
	// * @param instrument The instrument that contains the link.
	// * @throws InstantiationException If an error of instantiation
	...
	// provided.
	// */
	// protected Spinner2SelectionGrid(final ShapeGridCustomiser instrument)
	// throws InstantiationException, IllegalAccessException {
	...
	//
	//
	// private abstract static class ColourButtonForShapeGridCust<A extends
	// ShapePropertyAction> extends ColourButtonForCustomiser<A,
	// ShapeGridCustomiser> {
	// protected ColourButtonForShapeGridCust(final ShapeGridCustomiser
	// instrument, final Class<A> clazzAction) throws InstantiationException,
	// IllegalAccessException {
	// super(instrument, clazzAction);
	// }
	//
	...
	// interaction.getButton()==instrument.colourSubGrid;
	// }
	// }
	//
	//
	...
	// */
	// private static class ColourButton2PencilGrid extends
	// ColourButtonForShapeGridCust<ModifyPencilParameter> {
	// /**
	// * Creates the link.
	// * @param instrument The instrument that contains the link.
	// * @throws InstantiationException If an error of instantiation
	...
	// provided.
	// */
	// protected ColourButton2PencilGrid(final ShapeGridCustomiser instrument)
	// throws InstantiationException, IllegalAccessException {
	// super(instrument, ModifyPencilParameter.class);
	// }
	//
	...
	// * This link maps a colour button to the selected shapes.
	// */
	// private static class ColourButton2SelectionGrid extends
	// ColourButtonForShapeGridCust<ModifyShapeProperty> {
	// /**
	// * Creates the link.
	// * @param instrument The instrument that contains the link.
	// * @throws InstantiationException If an error of instantiation
	...
	// provided.
	// */
	// protected ColourButton2SelectionGrid(final ShapeGridCustomiser
