...
class PSTContext(var axesStyle : AxesStyle, var arrowStyle : (ArrowStyle, ArrowStyle), var arrowSize : (Double, Double),
	...
	def this(psCustom : Boolean) {
		this(null, Tuple2(ArrowStyle.NONE, ArrowStyle.NONE), Tuple2(PSTricksConstants.DEFAULT_ARROW_SIZE_DIM,
			...
			PSTricksConstants.DEFAULT_BORDER_COLOR, null, PSTricksConstants.DEFAULT_BORDER,
			...
			null, PSTricksConstants.DEFAULT_FILL_COLOR, PSTricksConstants.DEFAULT_GRID_WIDTH,
			...
			null, PSTricksConstants.DEFAULT_LINE_ARC, null,
			...
			PSTricksConstants.DEFAULT_SUBGRIDDIV, null, null,
			...
			ShapeFactory.INST.createPoint, "", "line", 50, null, 0, psCustom, "", 0, true,
